...
The `colourgen::make_palette` function returns a list object containing a base graphics `plot` preview and `palette` character vector which make generating, inspecing and fine-tuning color palettes a breeze.
...
```{r, echo=FALSE}
invisible(colourgen::make_palette("set1", 15))
```
